...
class GameScreenChallenge extends StatelessWidget {
  const GameScreenChallenge({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<QuatrowsChallengeBloc, QuatrowsStateChallenge>(
      builder: (context, state) {
                  ...
                  children: [
                    Positioned(
                      ...
                      child: IconButton(
                        onPressed: () {
                          context
                              .read<QuatrowsChallengeBloc>()
                              .add(ResetGameChallengeEvent());
                  ...
                  Center(
                    child: SizedBox(
                      ...
                      child: GridView.builder(
                        itemCount: state.listText.length,
        ...
        } else if (state is QuatrowsWinChallengeState) {
          return EndGame(
            onTap: () {
              context
                  .read<QuatrowsChallengeBloc>()
        ...
        } else if (state is QuatrowsLoseChallengeState) {
          return EndGame(
            onTap: () {
              context
                  .read<QuatrowsChallengeBloc>()
